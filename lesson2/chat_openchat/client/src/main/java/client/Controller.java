                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            ...
                            if (str.startsWith("/changeNickname_yes")) {
                                textArea.appendText("Ник успешно изменен.\n");
                                nickname = str.split("\\s+")[1];
                                setTitle(nickname);
                            }
                            if (str.startsWith("/changeNickname_no")) {
                                textArea.appendText("Ник не удалось сменить. Он уже занят другим пользователем.\n");
                            }
